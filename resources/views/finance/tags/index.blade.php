...
@section('content')
    ...
    <a href="{!! route('finance.tags.create') !!}" class="btn-floating btn-large waves-effect waves-light green btn-category-add"><i class="material-icons">add</i></a>
    <div class="row">
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn-floating waves-effect waves-light yellow lighten-1 button-edit">
                            {{ Form::open(['route' => ['finance.tags.edit', $tag->id], 'method' => 'get']) }}
                        ...
                        <a class="btn-floating waves-effect waves-light red lighten-1">
                            {{ Form::open(['route' => ['finance.tags.destroy', $tag->id], 'method' => 'delete']) }}
