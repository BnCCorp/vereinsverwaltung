    ...
    <div class="row">
        <div class="col l8 offset-l2 m8 offset-m2 s10 offset-s1">
            ...
            {!! Form::open(['route' => 'finance.transactions.store']) !!}
                ...
                {{ Form::select('finance_account_id', $accounts, null, ['placeholder' => 'Typ wählen...']) }}
                ...
                {{ Form::select('finance_category_id', $categories, null, ['placeholder' => 'Typ wählen...']) }}
                ...
                {{ Form::select('member_id', $members, null, ['placeholder' => 'Typ wählen...']) }}
                <div>
